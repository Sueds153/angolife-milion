          ...
          >
            {({ isActive }) => (
              <>
                ...
                <span className={`text-[8px] xs:text-[9px] font-black uppercase tracking-tighter mt-1 leading-none transition-all duration-300 ${isActive ? 'opacity-100' : 'opacity-50'}`}>
                  {item.label}
                </span>
                {isActive && (
