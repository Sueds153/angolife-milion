...
export const Footer: React.FC<FooterProps> = ({ onOpenLegal }) => {
  ...
  return (
    <footer className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white pt-16 pb-32 px-6 mt-12 relative overflow-hidden border-t border-orange-500/20 transition-colors duration-200">
